...
```
[FASE 1 — SECUENCIAL]
  spec-generator → .claude/specs/<feature>.spec.md  (DRAFT → APPROVED por el usuario)
...
## Proceso
1. Busca `.claude/specs/<feature>.spec.md`
...
## Comando status
Al recibir `status`: lista specs en `.claude/specs/` con su estado actual y próxima acción.
