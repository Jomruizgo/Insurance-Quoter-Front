...
El agente valida el requerimiento y genera `.claude/specs/<feature>.spec.md` con estado `DRAFT`.
...
```
@backend-developer implementa .claude/specs/<feature>.spec.md
@frontend-developer implementa .claude/specs/<feature>.spec.md
@database-agent diseña el modelo de datos para .claude/specs/<feature>.spec.md
```
...
```
@test-engineer-backend genera tests para .claude/specs/<feature>.spec.md
@test-engineer-frontend genera tests para .claude/specs/<feature>.spec.md
```
...
```
@documentation-agent documenta .claude/specs/<feature>.spec.md
```
...
|---|---|
| `Insurance-Quoter-Back/**` | `rules/backend.md` |
| `Insurance-Quoter-Front/**` | `rules/frontend.md` |
| Cualquier archivo de modelo/DB | `rules/database.md` |
| Cualquier archivo de test | `rules/testing.md` |
| `.claude/specs/**` | `rules/specs.md` |
